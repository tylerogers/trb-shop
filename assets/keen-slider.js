...
if (mediaQuery.matches) {
  ...
  function checkContainer() {
    ...
    function initalizeReviewSlider() {
      ...
      newEl.setAttribute("id", "dots");

      var ref = document.querySelector('div.spr-reviews');
      insertAfter(newEl, ref);

      var slider = new KeenSlider(".spr-reviews", {
        created: function (instance) {
          var dots_wrapper = document.getElementById("dots");
          var slides = document.querySelectorAll(".spr-review");
          console.log(slides);
